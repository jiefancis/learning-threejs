...
<template>
  ...
  */
  function init() {
    const wrapper = document.querySelector('#container') as HTMLDivElement;
    let clientW = wrapper.clientWidth, clientH = wrapper.clientHeight;
    ...
    const camera = new THREE.PerspectiveCamera(45, clientW/clientH, 0.1, 1000);
    ...
    function mousemove(e) {
      mouseX = e.clientX - clientW/2
      mouseY = e.clientY - clientH/2
    }
